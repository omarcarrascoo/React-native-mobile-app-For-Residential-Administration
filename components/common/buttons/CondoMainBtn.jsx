...
function CondoMainBtn({text, action, outline, alert}) {
  return (
    alert?
    (
    <TouchableOpacity onPress={action} style={outline === true? styles.outlineBtn : styles.btnAlert}>
...
const styles = StyleSheet.create({
  ...
  btnAlert:{backgroundColor:COLORS.alert2,padding:12, borderRadius:10, alignItems:"center", justifyContent:"center"},
